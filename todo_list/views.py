...
def home(request):
	return render(request, 'home.html', {'user' : "rjubarot"})

def about(request):
	my_name = "Renzel James"
	return render(request, 'about.html', {"myname": my_name})

def contact(request):
	return render(request, 'contact-us.html', {'user' : "rjubarot"})
...
def listings(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			context = {'all_items' : all_items, "user":"rjubarot"}
